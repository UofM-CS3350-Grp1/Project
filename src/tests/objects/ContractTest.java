...
public class ContractTest 
{
    ...
    {
        Contract contract = new Contract("Nickelback", "A band", 1000000.01, new Date(1402194845));
    ...
    {
        new Contract(null, "A band", 1000000.01, new Date(1402194845));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract3() 
    {
        new Contract("", "A band", 1000000.01, new Date(1402194845));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract4() 
    {
        new Contract("Nickelback", null, 1000000.01, new Date(1402194845));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract5() 
    {
        new Contract("Nickelback", "", 1000000.01, new Date(1402194845));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract6() 
    {
        new Contract("Nickelback", "A band", -1, new Date(1402194845));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract7() 
    {
        new Contract("Nickelback", "A band", 1000000.01, null);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract8() 
    {
        new Contract(null, null, -1, null);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract9() 
    {
        new Contract("", null, -1, null);
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testContract10() 
    {
        new Contract(null, null, 0.0, new Date(1402194845));
    }   

    @Test
    public void testContract11() 
    {
        Contract contract = new Contract("N", "A", 0.01, new Date(1402194845));
    ...
    {
        Contract contract = new Contract("Nickelback", "A band", 1000000.01, new Date(1402194820));
